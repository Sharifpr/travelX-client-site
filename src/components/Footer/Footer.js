...
const Footer = () => {
    return (
        <div className="mt-5" style={{ backgroundColor: "#8e44ad" }}>
            <footer className="section-footer border-top">
                <Container>
                    ...
                    <Row className="footer-bottom border-top">
                        <Col md={2}>
                            <p className="text-light"><BiCopyright /> {new Date().getFullYear()} TrevelX</p>
                        </Col>
                        <Col md={8} className="text-md-center">
                            <span className="px-2 text-light">New Elephant Road, Dhaka-1205, Bangladesh.</span>
                        </Col>
                        <Col md={2} className="text-md-right text-light">
